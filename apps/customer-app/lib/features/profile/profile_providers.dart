...
final profileOverviewProvider = FutureProvider.autoDispose<ProfileOverview>((ref) async {
  ...
  final user = userResult.when(success: (data) => data, failure: (error) => throw error);
