...
export class CustomersService {
  ...
  async upsertOwnProfile(
    ...
    const payload: Record<string, unknown> = {
      ...
      yearsAtCurrentAddress: dto.yearsAtCurrentAddress,
      ...
      additionalIncome: dto.additionalIncome?.toFixed(2),
      currentMonthlyEmi: dto.currentMonthlyEmi?.toFixed(2),
      creditCardCount: dto.creditCardCount,
      creditCardOutstanding: dto.creditCardOutstanding?.toFixed(2),
      existingLoansOutstanding: dto.existingLoansOutstanding?.toFixed(2),
      hasActiveExternalLoan: dto.hasActiveExternalLoan,
      externalLoanLenderName: dto.externalLoanLenderName,
      externalLoanOutstandingAmount: dto.externalLoanOutstandingAmount?.toFixed(2),
      externalLoanAccountLast4: dto.externalLoanAccountLast4,
      reference1Name: dto.reference1Name,
      reference1Phone: dto.reference1Phone,
      reference1Relationship: dto.reference1Relationship,
      reference2Name: dto.reference2Name,
      reference2Phone: dto.reference2Phone,
      reference2Relationship: dto.reference2Relationship,
    };
